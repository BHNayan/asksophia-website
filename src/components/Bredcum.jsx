...
const Bredcum = ({ShowButton, ShowTitle,ShowBredcum,Titletext}) => {
  return (
    <div className="w-full  h-[220px] md:h-[350px] p-4 bg-gradient-to-r from-[#3639b4] to-[#191b83] mb-2 lg:-mt-[20px] rounded-3xl flex flex-col justify-center items-center">
      {ShowButton && (
      ...
      {ShowTitle && (
        <div className="p-2">
          <h1 className="w-full md:w-[890px] text-center text-white text-[30px] md:text-[56px] font-bold font-['Mona Sans'] leading-[40px] md:leading-[69px]">
            {Titletext}
          </h1>
        </div>
      )}
